...
export const TimerActions = () => {
  ...
  return (
    <div className="actions">
      <button disabled={isRunning} onClick={() => dispatch(timerActions.startTimer())}>
        <img
          src="https://cdn-icons-png.flaticon.com/512/7709/7709039.png"
          alt="start"
        />
      </button>
      <button disabled={!isRunning} onClick={() => dispatch(timerActions.pauseTimer())}>
        <img
          src="https://cdn-icons-png.flaticon.com/512/2404/2404385.png"
          alt="pause"
        />
      </button>
      <button onClick={() => dispatch(timerActions.resetTimer())}>
        <img
